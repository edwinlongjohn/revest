                        ...
                        <div class="header_menu f-right">
                            <nav id="mobile-menu">
                                <ul class="main-menu">
                                    ...
                                    <li><a href="{{ route('investment.page') }}">Investment</a></li>
                                    <li class="menu-item-has-children"><a href="#"> Paage</a>
                                        <ul class="submenu">
                            ...
                            <div class="dashboard-side">
                                ...
                                <div class="dashboard-menu">
                                    <ul>
                                        ...
                                        <li><a href="{ route('upload.investment.package') }}"><i
                                                    class="ti-wallet"></i> Investment Package</a>
                                        </li>
                                        <li><a href="{ route('update.user.account') }}"><i
                                                    class="ti-import"></i>Account</a>
                                        </li>
